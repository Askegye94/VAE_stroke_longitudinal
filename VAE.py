...
Createinitialize = True # set to true if you want to train the model
useInitializeWeights = False # sey to false when training the model the first time

trainModel = True # set to true if you want to train the model
...
def get_loss(distribution_mean, distribution_variance):
    ...
    def get_reconstruction_loss(y_true, y_pred):
        ...
        return reconstruction_loss_batch*200*18 # has to be 200* 18
...
encoder = tf.keras.layers.Conv1D(20, 50,activation='relu')(input_data) # 20 filter, 50 kernal size
...
path = r'C:\Users\gib445\OneDrive - Vrije Universiteit Amsterdam\Desktop\New Python Scripts\3dPreparedData\\'
# path = "C:\\Users\\sdd380\\surfdrive\\Projects\\VAE_Stroke\\BACKUP\\"

data = 'stored_3D_other_data_withoutS01722_latentfeatures1_3_frequency_50.npy'
yFile = 'stored_y_3D_adapted_withoutS01722_latentfeatures1_3_frequency_50.npy'
groupFile = 'stored_3D_groupsplit_withoutS01722_latentfeatures1_3_frequency_50.npy'
...
for i in range(0,len(train_data)):
    # z.append(testy[i])
    train_new = train_data[i]
    train_new = np.expand_dims(train_new, axis=0)
    op1 = encoder_model.predict(train_new)
    encoded1.append(op1[0])
